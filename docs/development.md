...
Debug ビルドしたうえで `$JELLYFIN_CONFIG_DIR/plugins/Jellyfin.Plugin.AmazonMusic_<version>/`
...
├── jellyfin-12.0/
├── amazon-music_0.2.0.0_jellyfin-10.11.zip
├── amazon-music_0.2.0.0_jellyfin-10.11.zip.md5
├── amazon-music_0.2.0.0_jellyfin-12.0.zip
└── amazon-music_0.2.0.0_jellyfin-12.0.zip.md5
```
...
（<https://tkgstrator.github.io/Jellyfin-AmazonMusic-Metadata/>）に配置する。
...
```bash
GH_TOKEN=$(gh auth token) ./scripts/manifest.py tkgstrator/Jellyfin-AmazonMusic-Metadata /tmp/site
```
